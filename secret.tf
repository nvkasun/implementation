...
module "admin_secret_protected" {
  source = "git::https://github.com/AbuDhabiCommercialBank/aws-tf-module-secrets-manager.git?ref=v2.0.2"

  name                    = "dev/goldengate/admin-secret"
  description             = "Goldengate admin login secret key"
  recovery_window_in_days = 0
  safety_mode             = "protected"
...
module "admin_secret_target_protected" {
  source = "git::https://github.com/AbuDhabiCommercialBank/aws-tf-module-secrets-manager.git?ref=v2.0.2"

  name                    = "dev/goldengate/admin-secret-target"
  description             = "Goldengate admin login secret key"
  recovery_window_in_days = 0
  safety_mode             = "protected"
