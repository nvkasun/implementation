# REFERENCE ONLY -- not part of the envs/dev Terraform root and never loaded/applied from here. This is the exact module configuration that provisioned the live gg-repltest-mssql DEV instance, preserved for change-tracking after the module was detached from Terraform management (see envs/dev/rds_repltest_detach.tf).
