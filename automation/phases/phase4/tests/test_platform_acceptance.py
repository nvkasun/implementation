"""Offline tests for automation/phases/phase4/platform_acceptance.py (post-reconciliation acceptance: HEALTHY/BROKEN); run directly via `python3 automation/phases/phase4/tests/test_platform_acceptance.py`. No live Kubernetes -- every kubectl response is a fake, injected fixture. Exercises the classifier's actual logic (never merely greps its source). Pre-reconciliation ownership safety (ABSENT/OWNED/BROKEN) is a separate module -- see automation/phases/phase4/tests/test_platform_state.py."""
...
TOOL_PATH = REPO_ROOT / "automation" / "phases" / "phase4" / "platform_acceptance.py"
