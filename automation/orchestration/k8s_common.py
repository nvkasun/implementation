#!/usr/bin/env python3
"""Shared read-only Kubernetes inspection primitives for the platform, observability, and monitor classifiers. Helpers issue only kubectl get calls and never mutate the cluster."""
