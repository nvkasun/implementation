...
- `config.py` -- canonical deployment loading (staged `goldengate-deployments.yaml` registry, generated by `automation/goldengate-deployment-model.py`)
...
canonical deployment (discovered from the deployment-model-generated registry,
...
parsed exclusively by `automation/goldengate-deployment-model.py`. The workflow
