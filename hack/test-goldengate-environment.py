"""Offline tests for hack/goldengate-environment.py (IAM generated-policy source-of-truth correction); run directly via `python3 hack/test-goldengate-environment.py`."""
...
TOOL_PATH = os.path.join(REPO_ROOT, "hack", "goldengate-environment.py")
